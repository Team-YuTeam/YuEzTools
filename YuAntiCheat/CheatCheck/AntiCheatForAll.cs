        ...
        try
        {
            ...
            switch (rpc)
            {
                ...
                case RpcCalls.MurderPlayer:
                    if ((GetPlayer.IsLocalGame || GetPlayer.IsLobby) || pc.Data.IsDead || (pc.Data.RoleType != RoleTypes.Impostor && pc.Data.RoleType != RoleTypes.Shapeshifter && pc.Data.RoleType != RoleTypes.Phantom))
                    {
