    ...
    public static class GameOptionsMapPickerPatch
    {
        ...
        public static void Postfix_Initialize(GameOptionsMapPicker __instance)
        {
            ...
            if (AllMapButton != null)
            {
                ...
                dlekS_ehT_MapButton.MapIcon[5].transform.localScale = new Vector3(-1f, 1f, 1f);
                ...
                dlekS_ehT_MapButton.Button.OnClick.AddListener((Action)(() =>
                {
                    ...
                    __instance.MapImage.sprite = Utils.Utils.LoadSprite($"YuEzTools.Resources.DleksBanner.png", 100f);
                    __instance.MapName.sprite = Utils.Utils.LoadSprite($"YuEzTools.Resources.DleksBanner-Wordart.png", 100f);
                }));
